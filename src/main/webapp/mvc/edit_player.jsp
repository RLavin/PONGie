...
<div class="container">
    <div class="header clearfix">
        ...
        <h3 class="text-muted">Update This Player</h3>
    </div>
    ...
    <div class="row marketing">
        <div class="col-lg-6">
            ...
            <form method="post" action="/mvc/player/add">
                <table class="table">
                    <tr>
                        <td>Name:</td>
                        <td><input type="text"  name="name" value="<c:out value="${myEdit.name}"/>"></td>
                    </tr>
                    <tr>
                        <td>Nickname:</td>
                        <td><input type="text" name="nickname" value="<c:out value="${myEdit.nickname}"/>"></td>
                    </tr>
